	...
	export default {
		...
		methods: {
			...
			refresh(){
				...
				uni.request({
				url: "http://8.210.113.176:8080/potential/update/"+uni.getStorageSync('userId'),
				method: 'get',
				}).then(res=>{
					console.log('load',res[1].data)
			...
			deleteItem(id){
				...
				url: "http://8.210.113.176:8080/potential/delete/"+id,
				method: 'get',
				}).then(res=>{
					console.log('load',res[1].data)
					this.getList()
			...
			save(id){
				uni.request({
				url: "http://8.210.113.176:8080/potential/update/status/save/"+id,
				method: 'get',
				}).then(res=>{
					console.log('load',res[1].data)
					this.getList()
			...
			unsave(id){
				uni.request({
				url: "http://8.210.113.176:8080/potential/update/status/potential/"+id,
				method: 'get',
				}).then(res=>{
					console.log('load',res[1].data)
					this.getList()
